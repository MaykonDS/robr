...
.line-chart {
 ...
 @keyframes fadeIn {
        ...
        <br>
           ...
           <center>
            <div class="dropdown">
             ...
             <a href="InsertionSort.php?ano=2008&cargo=1">2008</a>
             <a href="InsertionSort.php?ano=2012&cargo=1">2012</a>
             <a href="InsertionSort.php?ano=2016&cargo=1">2016</a>
             <a href="InsertionSort.php?ano=2020">2020</a>
               </div>
           </div>
            ...
            <div class="dropdown">
             ...
             <div class="dropdown-content">
             <a href="InsertionSort.php?ano=2008&cargo=2">2008</a>
             <a href="InsertionSort.php?ano=2012&cargo=2">2012</a>
             <a href="InsertionSort.php?ano=2016&cargo=2">2016</a>
             <a href="InsertionSort.php?ano=2020">2020</a>
               </div>
           </div>
            ...
            <div class="dropdown">
             ...
             <div class="dropdown-content">
             <a href="InsertionSort.php?ano=2008&cargo=3">2008</a>
             <a href="InsertionSort.php?ano=2012&cargo=3">2012</a>
             <a href="InsertionSort.php?ano=2016&cargo=3">2016</a>
             <a href="InsertionSort.php?ano=2020">2020</a>
               </div>
           </div>
            <div class="dropdown">
    ...
    $array = insertionSort($array,count($array));
    ...
    $cands[$i] = $array[$i]['nome'];
     ...
     echo "<p style='color:white;'>Algoritimo Insertion Sort</p>";
     echo "<p style='color:white;'>".$array['InsertionSort']["tempo"]."</p>";
